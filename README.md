...
![Graph SDK](https://img.shields.io/badge/Graph_SDK-0078D4?style=for-the-badge&logo=microsoft&logoColor=white)
...
**2. Set execution policy for lab work**
```powershell
Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser
```

**3. Run the first lab script**
```powershell
...
### [StoneZoneSecurity.com/M365-Migrations](https://StoneZoneSecurity.com/M365-Migrations)
...
```mermaid
flowchart LR
    A["🔍 DISCOVERY<br/>• Audit<br/>• Manifest<br/>• Assess<br/><i>Script: 04</i>"] --> B["📋 PLANNING<br/>• Provision<br/>• Configure<br/>• Pilot<br/><i>Scripts: 01, 02, 03</i>"]
    B --> C["🚀 EXECUTION<br/>• Migrate<br/>• Forward<br/>• Cutover<br/><i>Scripts: 05, 06, 07</i>"]
    C --> D["✅ VALIDATION<br/>• Reports<br/>• Cleanup<br/>• Optimize<br/><i>Script: 08</i>"]
```
...
[Get the Book](https://StoneZoneSecurity.com) · [Resource Hub](https://StoneZoneSecurity.com/M365-Migrations) · [Report an Issue](https://github.com/STONEZONEBIZ/M365-Migration-Scripts/issues)
